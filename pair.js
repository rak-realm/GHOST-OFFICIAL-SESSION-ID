            ...
            if (connection === 'open') {
                ...
                try {
                    await sock.sendMessage(sock.user.id, {
                        text: `🚀 *GHOST-OFFICIAL-V1 Activated*\n\n` +
...
app.get('/health', (req, res) => {
    res.json({ 
        status: 'OK', 
        service: 'GHOST-OFFICIAL-V1 Pairing Server',
...
// Start server
app.listen(PORT, () => {
    console.log(`🚀 GHOST-OFFICIAL-V1 Pairing Server running on port ${PORT}`);
    console.log(`📱 RAK Realm Channel: https://whatsapp.com/channel/0029VazawLiDp2QEO1Ttwg28`);
