...
app.get('/health', (req, res) => {
  res.json({
    status: 'OK',
    service: 'GHOST-OFFICIAL-V1 Server',
    version: '1.0.0',
...
app.get('/api', (req, res) => {
  res.json({
    ...
    documentation: 'https://github.com/RAK-Realm/ghost-official-v1'
  });
});
...
const startServer = async () => {
  try {
    ...
    app.listen(PORT, () => {
      console.log('\n' + '='.repeat(50));
      console.log('?? GHOST-OFFICIAL-V1 Server Started');
      console.log('='.repeat(50));
      console.log(`?? Port: ${PORT}`);
      console.log(`?? URL: http://localhost:${PORT}`);
      console.log(`?? Health: http://localhost:${PORT}/health`);
      console.log(`?? Environment: ${process.env.NODE_ENV || 'development'}`);
      console.log('?? RAK Realm Automation Ecosystem');
      console.log('?? Channel: https://whatsapp.com/channel/0029VazawLiDp2QEO1Ttwg28');
      console.log('='.repeat(50));
